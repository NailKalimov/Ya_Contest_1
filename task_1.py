""" офисе, где работает программист Петр, установили кондиционер нового типа. 
...
def adjust_temperature(t_room, t_cond, mode):
    if mode == 'auto':
        return t_cond
    elif mode == 'fan':
        return t_room
...
t_room, t_cond = (int(i) for i in (stdin.readline().split()))
mode = stdin.readline().rstrip("\n")
print(adjust_temperature(t_room, t_cond, mode))
